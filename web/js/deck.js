...
function build_div(record) {
  ...
  if (is_reboot_changed(record.code)){
      influ += '<span style="opacity:0">' + '●'.repeat(7 - record.faction_cost) + '</span><span title="Changed in Reboot" style="display:inline-block;width:1.5em;">🥾</span>';
  }
